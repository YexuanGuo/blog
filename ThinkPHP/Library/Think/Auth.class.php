...
class Auth{
    ...
    protected $_config = array(
        ...
        'AUTH_GROUP'        => 'operation_auth_group',        // 用户组数据表名
        'AUTH_GROUP_ACCESS' => 'operation_auth_group_access', // 用户-用户组关系表
        'AUTH_RULE'         => 'operation_auth_rule',         // 权限规则表
        'AUTH_USER'         => 'operation_account'             // 用户信息表
    );
