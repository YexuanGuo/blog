                ...
                <div class="ibox-content">
                    ...
                    <table class="table table-striped table-bordered table-hover product_dataTables" id="auth_dataTables" >
                        ...
                        <?php if(is_array($data)): foreach($data as $key=>$v): ?><tr>
                                ...
                                <td>
                                    <a href="/configure/auth/create/<?php echo ($v['id']); ?>">添加子权限</a> |
                                    <a href="/configure/auth/update/<?php echo ($v['id']); ?>">修改</a> |
                                    <a href="/configure/auth/delete/<?php echo ($v['id']); ?>">删除</a>
                                </td>
...
//                    return ("<a href=/configure/auth/update/"+data+"><button type='button' class='btn btn-xs btn-primary'>更新权限规则</button></a>" +
//                    "  <a href=/configure/auth/delete/"+data+"><button type='button' class='btn btn-xs btn-danger'>删除</button></a>");
//                }
//            },
//
...
//            "sInfo": "当前数据为从第 _START_ 到第 _END_ 条数据；总共有 _TOTAL_ 个权限规则。",
//            "sInfoEmtpy": "没有数据。",
//            "sLoadingRecords": "载入中...",
//            "sProcessing": "正在加载数据...",
