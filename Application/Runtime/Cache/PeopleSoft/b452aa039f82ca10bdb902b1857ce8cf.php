...
<div class="row wrapper border-bottom white-bg page-heading">
    <div class="col-lg-10">
        ...
        <ol class="breadcrumb">
            <li>
                <a href="/index">西科码数据管理平台</a>
            </li>
            <li class="active">
                <strong>星火万方管理</strong>
            </li>
        </ol>
    </div>
    <div class="col-lg-2">
        ...
        <div class="col-lg-12">
            <div class="ibox float-e-margins">
                ...
                <div class="ibox-content">
                    <div class="">
                        <a href="#" class="btn btn-primary " id="filePicker" name="import_file">Click Me ImportExcel</a>
                    </div>
...
<script type="application/javascript">
    ...
    $('.product_dataTables').DataTable({
        ...
        "sAjaxSource": "/sparkcontrol/query",
...
//                    return ("<a href=#"+data+"><button type='button' class='btn btn-xs btn-primary'>更新</button></a>");
//                }
//            },
        ...
        "oLanguage": {                          //汉化
            ...
            "sInfo": "当前数据为从第 _START_ 到第 _END_ 条数据；总共有 _TOTAL_ 条产品。",
            "sInfoEmtpy": "没有数据。",
            "sLoadingRecords": "载入中...",
            //"sProcessing": Loading,
