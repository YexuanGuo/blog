        ...
        <div class="col-lg-12">
            <div class="ibox float-e-margins">
                ...
                <div class="ibox-content">
                    <form class="form-horizontal m-t-md" id="usergroup_form" method="post" action="/configure/menu/update">
                        <div class="form-group">
                            <label class="col-sm-2 col-sm-2 control-label">菜单名称</label>
                            <div class="col-sm-9">
                                <input type="text" class="form-control" placeholder="菜单名称" id="menu_name" name="menu_name" value="<?php echo ($menuInfo["name"]); ?>">
                            </div>
                            <input type="hidden" name="menu_id" value="<?php echo ($menuInfo["id"]); ?>">
                        </div>
                        <div class="form-group">
                            <label class="col-sm-2 control-label">Style</label>
                            <div class="col-sm-9">
                                <input type="text" class="form-control" placeholder="Style" id="menu_style" name="menu_style" value="<?php echo ($menuInfo["class"]); ?>">
                            </div>
                        </div>
                        <div class="form-group">
                            <label class="col-sm-2 control-label">Controller</label>
                            <div class="col-sm-9">
                                <input type="text" class="form-control" placeholder="Style" id="controller" name="controller" value="<?php echo ($menuInfo["controller"]); ?>">
                            </div>
                        </div>
                        <div class="form-group">
                            <label class="col-sm-2 control-label">Action</label>
                            <div class="col-sm-9">
                                <input type="text" class="form-control" placeholder="Style" id="action" name="action" value="<?php echo ($menuInfo["action"]); ?>">
                            </div>
                        </div>
                        <div class="form-group">
                            <label class="col-sm-2 control-label">Pid</label>
                            <div class="col-sm-9">
                                <input type="text" class="form-control" placeholder="Style" id="pid" name="pid" value="<?php echo ($menuInfo["pid"]); ?>">
                            </div>
                        </div>
                        <div class="form-group">
                            <label class="col-sm-2 control-label">Level</label>
                            <div class="col-sm-9">
                                <input type="text" class="form-control" placeholder="Style" id="level" name="level" value="<?php echo ($menuInfo["level"]); ?>">
                            </div>
                        </div>
                        <div class="form-group">
...
<script type="application/javascript">
    ...
    /*Select默认选中*/
    var select_data = [<?php echo ($userGroupInfo["rules"]); ?>];
    $(".chosen-select").select2('val',select_data);
</script>
<div class="footer">
