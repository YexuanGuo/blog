        ...
        <div class="col-lg-12">
            <div class="ibox float-e-margins">
                ...
                <div class="ibox-content">
                    <form class="form-horizontal m-t-md" id="file_upload_form" method="post" action="/developer/fileupload/upload" enctype="multipart/form-data">
                        <div class="form-group">
                            <label class="col-sm-2 control-label">Bucket</label>
                            <div class="col-sm-9">
                                <select class="form-control" style="width:100%;" tabindex="2" cols="40" name="route">
                                    <option value="">Select</option>
                                    <?php foreach($RouteList as $k=>$v){ ?>
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-9">
                                <input type="file" class="form-control" placeholder="" id="FileName" name="FileName">
                            </div>
                        </div>
