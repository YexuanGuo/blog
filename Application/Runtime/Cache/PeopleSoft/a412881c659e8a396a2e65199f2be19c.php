        ...
        <div class="col-lg-12">
            <div class="ibox float-e-margins">
                ...
                <div class="ibox-content">
                    <form class="form-horizontal m-t-md" id="usergroup_form" method="post" action="/configure/usergroup/create">
                        <div class="form-group">
                            <label class="col-sm-2 col-sm-2 control-label">名称</label>
                            <div class="col-sm-9">
                                <input type="text" class="form-control" placeholder="用户组名称" id="group_name" name="group_name">
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-9">
                                <select data-placeholder="选择用户" class="chosen-select" multiple style="width:100%;" tabindex="2" cols="40" id="chosen_select" name="uid_list[]">
                                    <option value="0">Select</option>
                                    <?php foreach($userList as $k=>$v){ var_dump($v);?>
                                        <option value="<?=$v['fid'];?>"><?=$v['fnickname'];?></option>
                                    <?php } ?>
                                </select>
                            </div>
                        </div>
