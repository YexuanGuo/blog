        ...
        <div class="col-lg-12">
            <div class="ibox float-e-margins">
                ...
                <div class="ibox-content">
                    <form class="form-horizontal m-t-md" id="usergroup_form" method="post" action="/configure/adminlist/update">
                        <div class="form-group">
                            <label class="col-sm-2 col-sm-2 control-label">用户名</label>
                            <div class="col-sm-9">
                                <input type="text" class="form-control" id="account" name="account" value="<?php echo ($userInfo["accout"]); ?>">
                            </div>
                            <input type="hidden" name="user_id" value="<?php echo ($userInfo["user_id"]); ?>">
                        </div>
                        <div class="form-group">
                            <label class="col-sm-2 col-sm-2 control-label">密码(留空不修改)</label>
                            <div class="col-sm-9">
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-9">
                                <input type="text" class="form-control" id="nickname" name="group_name" value="<?php echo ($userInfo["nickname"]); ?>">
                            </div>
                            <input type="hidden" name="user_id" value="<?php echo ($userInfo["user_id"]); ?>">
                        </div>
                        <div class="form-group">
                            ...
                            <div class="col-sm-9">
                                <select data-placeholder="选择用户组" class="form-control m-b chosen-select" multiple style="width:100%;" tabindex="2" cols="40" id="chosen_select" name="usergroup_id[]">
                                    <option value="" >NoGroupSelect,Please Select!</option>
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-9">
                                <textarea cols="40" rows="10" class="form-control" placeholder="备注" id="remarks" name="remarks"><?php echo ($userInfo["remarks"]); ?></textarea>
                            </div>
                        </div>
                        <div class="form-group">
...
<link href="/Public/css/plugins/select2/select2.min.css?v=2.0" rel="stylesheet" />
...
<script type="application/javascript">
    ...
    /*Select默认选中*/
    var select_data = [<?php echo ($vegroulist); ?>];
