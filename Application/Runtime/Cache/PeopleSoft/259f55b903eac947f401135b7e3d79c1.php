            ...
            <div class="ibox float-e-margins">
                ...
                <div class="ibox-content">
                    ...
                    <div class="table-responsive">
                        <div class="">
                            <a href="/article/articlelist/create" class="btn btn-primary">添加文章</a>
                        </div>
...
<script type="application/javascript">
    $('.product_dataTables').DataTable({
        ...
        "sAjaxSource": "/article/articlelist/query",
        ...
        "columns": [
            ...
            { "data": 'id',
                "render":function(data,type,full,callback){
                    return ("<a href=/article/articlelist/detail/"+data+" target='_blank'>点击查看</a>");
                }
            },
            { "data": 'category_id'},
            { "data": 'is_top'},
            ...
            { "data": 'id',
                "render":function(data,type,full,callback){
                    return ("<a href=/article/articlelist/update/"+data+"><button type='button' class='btn btn-xs btn-primary'>更新</button></a> " +
                        "<a href=/article/articlelist/delete/"+data+"><button type='button' class='btn btn-xs btn-danger'>删除</button></a>");
                }
            }
        ],
        "iDisplayLength":10,
        ...
        "oLanguage": {                          //汉化
            ...
            "sInfo": "当前数据为从第 _START_ 到第 _END_ 篇文章；总共有 _TOTAL_ 篇文章。",
            "sInfoEmtpy": "没有数据。",
            "sLoadingRecords": "载入中...",
            //"sProcessing": Loading,
