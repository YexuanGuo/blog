        ...
        <div class="col-lg-12">
            <div class="ibox float-e-margins">
                ...
                <div class="ibox-content">
                    <div class="">
                        <a href="/configure/menu/create" class="btn btn-primary ">添加新一级菜单</a>
                    </div>
                    <table class="table table-striped table-bordered table-hover " id="editable" >
                        ...
                        <tbody>
                            <?php if(is_array($data)): foreach($data as $key=>$v): ?><tr>
                                    <td>
                                        <input class="input-medium" style="width:40px;height:25px;" type="text" name="<?php echo ($v['id']); ?>" value="<?php echo ($v['id']); ?>">
                                    </td>
                                    ...
                                    <td>
                                        <a href="/configure/menu/add/<?php echo ($v['id']); ?>">添加子菜单</a> |
                                        <a href="/configure/menu/update/<?php echo ($v['id']); ?>">修改</a> |
                                        <a href="/configure/menu/delete/<?php echo ($v['id']); ?>">删除</a>
                                    </td>
