        ...
        <div class="col-lg-7">
            <div class="ibox float-e-margins">
                <div class="ibox-title">
                    <h5>微信Configure <small>AccessToken2小时生成一次</small></h5>
                ...
                <div class="ibox-content">
                    <form class="form-horizontal m-t-md" action="form_advanced.html#">
                        <div class="form-group">
                            <label class="col-sm-2 col-sm-2 control-label">appId</label>
                            <div class="col-sm-10">
                                <input type="text" class="form-control appid" placeholder="" value="<?php echo ($config["0"]["app_id"]); ?>">
                                <span class="help-block">微信公众后台配置</span>
                            </div>
                        </div>
                        <div class="form-group">
                            <label class="col-sm-2 control-label">appsecret</label>
                            <div class="col-sm-10">
                                <input type="text" class="form-control appsecret" placeholder="" value="<?php echo ($config["0"]["appsecret"]); ?>">
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-10">
                                <button type="button" class="btn btn-w-m btn-primary configure_button">Configure</button>
                            </div>
                        </div>
                    </form>
                </div>
...
<script type="application/javascript">
    $(document).ready(function(){
        $(".configure_button").click(function(){
            ...
            if(appid == '' || appsecret == '')
            {
                sweetAlert("配置失败...", "请认真填写appid和appsecret", "error");
                return false;
            }
            else
            {
                $.post('/wxservice/configure/',{
                    appid:appid,
                    appsecret:appsecret,
                },function(res){
                    if(res.code == 200){
                        swal("配置成功", "You clicked the close button!", "success");
                    }else{
                        sweetAlert("配置失败...", "Something went wrong!", "error");
                    }
                });
//            swal({
//                     title: "配置",
