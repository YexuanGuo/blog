        ...
        <div class="col-lg-12">
            <div class="ibox float-e-margins">
                ...
                <div class="ibox-content">
                    <form class="form-horizontal m-t-md" id="usergroup_form" method="post" action="/configure/usergroup/update">
                        ...
                        <table class="table table-striped table-bordered table-hover " id="editable" >
                            <tr>
                                ...
                                <td>
                                    <div class="col-sm-9">
                                        <input type="text" class="form-control" placeholder="用户组名称" id="group_name" name="group_name" value="<?php echo ($userGroupInfo["title"]); ?>">
                                    </div>
                                    <input type="hidden" name="usergroup_id" value="<?php echo ($userGroupInfo["id"]); ?>">
                                </td>
                            </tr>
                            <?php if(is_array($rule_data)): foreach($rule_data as $key=>$v): if(empty($v['_data'])): ?><tr class="b-group">
                                    ...
                                    <tr class="b-group">
                                        <th width="10%">
                                            <label><?php echo ($v['title']); ?> <input type="checkbox" name="rule_ids[]" value="<?php echo ($v['id']); ?>" <?php if(in_array($v['id'],$group_data['rules'])): ?>checked="checked"<?php endif; ?> onclick="checkAll(this)"></label>
                                        </th>
                                        <td class="b-child">
                                            <?php if(is_array($v['_data'])): foreach($v['_data'] as $key=>$n): ?><table class="table table-striped table-bordered table-hover table-condensed">
                                                    <tr class="b-group">
                                                        <th width="12%">
                                                            <label><?php echo ($n['title']); ?>
                                                                <input type="checkbox" name="rule_ids[]" value="<?php echo ($n['id']); ?>" <?php if(in_array($n['id'],$group_data['rules'])): ?>checked="checked"<?php endif; ?> onclick="checkAll(this)">
                                                            </label>
                                                        </th>
                                                        <td>
                            ...
                            <tr>
                                ...
                                <td>
                                    <div class="col-sm-9">
                                        <textarea cols="40" rows="10" class="form-control" placeholder="备注" id="remarks" name="remarks"><?php echo ($userGroupInfo["remarks"]); ?></textarea>
                                    </div>
                                </td>
                            </tr>
                            <tr>
