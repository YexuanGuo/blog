...
<script type="application/javascript">
    ...
    $('.product_dataTables').DataTable({
        ...
        "sAjaxSource": "/salecontrol/feedback/query",
        ...
        "columns": [
            ...
            { "data": 'id',
                "render":function(data,type,full,callback){
                    return ("<a href=#"+data+"><button type='button' class='btn btn-xs btn-primary'>回复</button></a>");
                }
            },
        ...
        "oLanguage": {                          //汉化
            ...
            "sInfo": "当前数据为从第 _START_ 到第 _END_ 条数据；总共有 _TOTAL_ 条实时反馈消息。",
            "sInfoEmtpy": "没有数据。",
            "sLoadingRecords": "载入中...",
            //"sProcessing": Loading,
