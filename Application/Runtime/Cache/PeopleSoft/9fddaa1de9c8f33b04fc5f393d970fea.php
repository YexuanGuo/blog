...
<div class="ibox-title">
    <h5>部署上线，在下面选择相应的仓库地址，然后PushLive</h5>
    ...
    <?php foreach($LogList as $key=>$v){?>
        <tr class="gradeX">
            ...
            <td>
                ...
                <button class="btn btn-primary commit"  data-style="zoom-in">PushLive</button>
                <button class="btn btn-danger rockback"  data-style="zoom-in">回滚</button>
