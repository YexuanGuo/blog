        ...
        <div class="col-lg-12">
            <div class="ibox float-e-margins">
                ...
                <div class="ibox-content">
                    <div class="">
                        <a href="/developer/fileupload/upload" class="btn btn-primary ">上传</a>
                    </div>
...
<script type="application/javascript">
    ...
    var img_domain = 'http://moeya.oss-cn-hangzhou.aliyuncs.com/';
    $('.product_dataTables').DataTable({
        //"processing": true,
        "serviceSize":true,
        "serverSide": true,//打开后台分页
        "sAjaxSource": "/developer/fileupload/query",
        ...
        "columns": [
            ...
            { "data": 'static_name',
                "render":function(data,type,full,callback){
                    return ("<a href="+img_domain+data+" target='_blank'>"+data+"</a> ");
                }
            },
            { "data": 'static_route'},
            { "data": 'full_url'},
            ...
            { "data": 'static_name',
                "render":function(data,type,full,callback){
                    return ("<a href=/developer/fileupload/delete?id="+data+"><button type='button' class='btn btn-xs btn-danger deleteFile' id='delete_button'>删除</button></a> ");
                }
            },
        ...
        "oLanguage": {                          //汉化
            ...
            "sInfo": "当前数据为从第 _START_ 到第 _END_ 条数据；总共有 _TOTAL_ 个文件。",
            "sInfoEmtpy": "没有数据。",
            "sLoadingRecords": "载入中...",
            //"sProcessing": Loading,
