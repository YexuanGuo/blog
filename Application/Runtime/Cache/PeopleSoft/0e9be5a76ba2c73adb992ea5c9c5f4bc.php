        ...
        <div class="col-lg-12">
            <div class="ibox float-e-margins">
                ...
                <div class="ibox-content">
                    <form class="form-horizontal m-t-md" id="menu_create_form" method="post" action="/configure/menu/create">
                        <div class="form-group">
                            <label class="col-sm-2 col-sm-2 control-label">菜单名称</label>
                            <div class="col-sm-9">
                                <input type="text" class="form-control" placeholder="" id="MenuTitle" name="MenuTitle">
                            </div>
                        </div>
                        <div class="form-group">
                            <label class="col-sm-2 col-sm-2 control-label">Controller</label>
                            <div class="col-sm-9">
                                <input type="text" class="form-control" placeholder="" id="Controller" name="Controller">
                            </div>
                        </div>
                        <div class="form-group">
                            <label class="col-sm-2 col-sm-2 control-label">Action</label>
                            <div class="col-sm-9">
                                <input type="text" class="form-control" placeholder="" id="Action" name="Action">
                            </div>
                        </div>
                        <div class="form-group">
                            <label class="col-sm-2 col-sm-2 control-label">StyleClass</label>
                            <div class="col-sm-9">
                                <input type="text" class="form-control" placeholder="" id="StyleClass" name="StyleClass">
                            </div>
                        </div>
                        <div class="form-group">
