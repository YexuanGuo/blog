        ...
        <div class="col-lg-12">
            <div class="ibox float-e-margins">
                ...
                <div class="ibox-content">
                    <form id="my-awesome-dropzone" class="dropzone" action="/Deploy/upd_zip">
                        <div class="dropzone-previews"></div>
                        <!--<button type="submit" class="btn btn-primary pull-right">Submit this form!</button>-->
                    </form>
                    <div>
                        <div class="m text-right"><small>请将打包好的ZIP文件拖到此处上传</small> </div>
                    </div>
                </div>
            </div>
        </div>
...
<script type="application/javascript">
    Dropzone.options.myAwesomeDropzone = {
        paramName: "zip_files", // The name that will be used to transfer the file
        maxFilesize: 102, // MB
    };
</script>
<div class="footer">
