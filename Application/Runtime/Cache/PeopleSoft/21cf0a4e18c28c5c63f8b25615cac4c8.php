        ...
        <div class="col-lg-12">
            <div class="ibox float-e-margins">
                ...
                <div class="ibox-content">
                    <form class="form-horizontal m-t-md" id="usergroup_form" method="post" action="/article/category/update">
                        <input type="hidden" name="pid" value="<?php echo ($_GET["create"]); ?>">
                        <div class="form-group">
                            <label class="col-sm-2 col-sm-2 control-label">名称</label>
                            <div class="col-sm-9">
                                <input type="text" class="form-control" placeholder="名称" id="name" name="name" value="<?php echo ($data["name"]); ?>">
                            </div>
                        </div>
                        <div class="form-group">
                            <label class="col-sm-2 col-sm-2 control-label">排序</label>
                            <div class="col-sm-9">
                                <input type="text" class="form-control" placeholder="分类排序" id="sort" name="sort" value="<?php echo ($data["sort"]); ?>">
                            </div>
                        </div>
                        <input type="hidden" name="update_id" value="<?php echo ($_GET['update']); ?>">
                        <!--<div class="form-group">-->
                            <!--<label class="col-sm-2 col-sm-2 control-label">是否在导航栏显示</label>-->
                            <!--<div class="col-sm-9">-->
                                <!--<input type="text" class="form-control" placeholder="是否在导航栏显示" id="is_display_nav" name="is_display_nav">-->
                            <!--</div>-->
                        <!--</div>-->
                        <!--<div class="form-group">-->
                            <!--<label class="col-sm-2 col-sm-2 control-label">是否启用</label>-->
                            <!--<div class="col-sm-9">-->
                                <!--<input type="text" class="form-control" placeholder="用户密码" id="is_enable" name="is_enable">-->
                            <!--</div>-->
                        <!--</div>-->
                        <div class="form-group">
                            <label class="col-sm-2 control-label">备注</label>
                            <div class="col-sm-9">
                                <textarea cols="40" rows="10" class="form-control" placeholder="备注" id="remarks" name="remarks"><?php echo ($data["remark"]); ?></textarea>
                            </div>
                        </div>
                        <div class="form-group">
...
<script src="/Public/js/moe/article.category.create.js"></script>
<div class="footer">
