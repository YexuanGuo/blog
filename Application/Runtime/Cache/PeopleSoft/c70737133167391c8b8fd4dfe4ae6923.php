                ...
                <div class="ibox-content">
                    ...
                    <table class="table table-striped table-bordered table-hover " id="editable" >
                        ...
                        <tr class="gradeX">
                            ...
                            <td><?=$v['faccount'];?></td>
                            <td><?=$v['fnickname'];?></td>
                            <td class="center"><?=date('Y-m-d H:i:s',$v['flastlogintime']);?></td>
                            <td class="center"><?=$v['flastloginip'];?></td>
                            <td class="center">
                                <button type="button" class="btn btn-xs btn-primary">更新订单信息</button>
                                <button type="button" class="btn btn-xs btn-danger">删除订单</button>
                            </td>
                        </tr>
                        <?php } ?>
                        </tbody>
