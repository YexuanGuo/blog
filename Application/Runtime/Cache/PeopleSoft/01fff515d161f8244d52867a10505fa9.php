        ...
        <div class="col-lg-12">
            <div class="ibox float-e-margins">
                ...
                <div class="ibox-content">
                    <form class="form-horizontal m-t-md" id="usergroup_form" method="post" action="/article/articlelist/update">
                        <div class="form-group">
                            <label class="col-sm-2 col-sm-2 control-label">标题</label>
                            <div class="col-sm-9">
                                <input type="text" class="form-control" placeholder="名称" id="name" name="title" value="<?php echo ($data["title"]); ?>">
                            </div>
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-9">
                                <input type="text" class="form-control" placeholder="分类" id="category" name="category" value="<?php echo ($data["category_id"]); ?>">
                            </div>
                        </div>
                        <div class="form-group">
...
<script src="/Public/js/moe/article.update.js"></script>
<script type="application/javascript">
    ...
    $("#category").select2('val',category_id);
    $("#is_top").select2('val',<?php echo ($data["is_top"]); ?>);
    $("#is_enable").select2('val',<?php echo ($data["is_enable"]); ?>);
</script>
...
<script type="application/javascript">
    ...
    var content = '<?=htmlspecialchars_decode($data["content"]);?>';
