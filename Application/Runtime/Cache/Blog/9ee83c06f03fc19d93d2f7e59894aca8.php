...
<section class="container user-select">
    <header class="hidden-xs">
        <div class="hidden-xs header clearfix"><!--超小屏幕不显示-->
            <h1 class="logo"> <a href="index.html" title="个人技术博客"></a> </h1>
            <ul class="nav hidden-xs-nav clearfix">
...
<aside class="sidebar visible-lg"><!--右侧>992px显示-->
    ...
    <div class="sidebar-block comment">
        ...
        <ul>
            <li data-toggle="tooltip" data-placement="top" title="站长的评论"><a target="_blank" href=""><span class="face"><img src="images/icon/logo.png" alt=""></span> <span class="text"><strong>个人技术博客站长</strong> (2015-10-18) 说：<br />
...
<!--/右侧>992px显示-->
<footer class="footer">POWERED BY &copy;<a href="#">codedance.cn</a> ALL RIGHTS RESERVED
    <span>
        ...
        var position = function(element) {
            ...
            $(window).scroll(function() { //侦听滚动时
                ...
                if (scrolls > top) { //如果滚动到页面超出了当前元素element的相对页面顶部的高度
                    ...
                    element.removeAttr("style").removeClass("shadow");//移除阴影样式.shadow
                }
            });
        };
